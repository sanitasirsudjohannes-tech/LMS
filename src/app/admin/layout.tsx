    ...
    <div className="space-y-6 py-2">
      ...
      <div className="bg-slate-900 text-white rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-bold">Admin Dashboard LMS</h1>
          <p className="text-xs text-slate-300 mt-0.5">RSUD Prof. Dr. W. Z. Johannes • Kelola Pelatihan Online</p>
        </div>
      </div>
