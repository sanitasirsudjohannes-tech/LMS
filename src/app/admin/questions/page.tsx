    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button onClick={handleOpenCreate} disabled={!selectedTrainingId} className="px-4 py-2 bg-[#07375c] hover:bg-[#052c4a] text-white rounded-xl text-xs font-bold shadow-sm inline-flex items-center gap-1 disabled:opacity-50"><Plus className="w-4 h-4" /><span>Tambah Soal</span></button>
        </div>
      </div>
