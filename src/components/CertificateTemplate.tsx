  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-[54px] flex flex-col">
        ...
        {/* Main Body */}
        <div className="my-5 text-center space-y-3 relative z-10">
        ...
        <div className="mt-auto pt-4 border-t border-slate-200 grid grid-cols-2 items-end gap-4 relative z-10 font-sans">
