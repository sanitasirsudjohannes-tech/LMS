...
export default function CertificateTemplate({ certificate, settings, previewMode = false }: CertificateTemplateProps) {
  ...
  const verifyUrl = previewMode ? 'LONTAR-PREVIEW-NOT-VALID' : `${origin}/verify/${certificate.verification_code}`;
    ...
    <div className="absolute left-[208px] right-[54px] top-[38px] bottom-[68px] flex flex-col">
      <div className="relative z-10 shrink-0 font-sans">
        <div className="relative flex min-h-[76px] items-center justify-center border-b-2 border-[#2b8a81] pb-2 text-center">
          <Image src="/logo-ntt.png" alt="Logo Pemerintah Provinsi Nusa Tenggara Timur" width={70} height={70} unoptimized className="absolute left-1 top-0 h-[70px] w-[70px] object-contain"/>
